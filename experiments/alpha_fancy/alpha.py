...
class AlphaDataset(Dataset):
    ...
    atom_feature_size = 119 # NOTE change this depenending on number of node features
    ...
    def __init__(self, 
        ...
        self.new_edge_funcs = {"edge_construction_functions": [add_peptide_bonds, add_bond_order, add_hydrogen_bond_interactions, add_atomic_edges]
    ...
    def __getitem__(self, idx):
        ...
        data.x = torch.cat([one_hot, h_donors, h_acceptors, physio_chem, atom_encoded], dim =1)
